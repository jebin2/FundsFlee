      ...
      <div className="flex flex-col gap-4 pt-4">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-1.5 mt-1">
                ...
                <span style={{ fontSize: 12, color: "#2e7d32", fontWeight: 600 }}>Connected</span>
              </div>
            </div>
          </div>
          {sheetUrl ? (
            ...
            <p style={{ fontSize: 14, color: "var(--color-outline)" }}>Sheet URL loading…</p>
          )}
        </div>
        ...
        <div className="rounded-3xl border overflow-hidden" style={{ borderColor: "var(--color-outline-variant)", background: "var(--color-surface-container-lowest)" }}>
          {[
            ...
            { label: "Total transactions", value: txCount !== null ? `${txCount} rows` : "Loading…" },
          ].map(({ label, value }, i, arr) => (
            <div key={label} className="flex justify-between items-center px-4 py-3.5" style={{ borderBottom: i < arr.length - 1 ? "1px solid var(--color-surface-variant)" : "none" }}>
          ...
          <div className="p-4">
            <button
              ...
              style={{ borderColor: "var(--color-primary)", color: "var(--color-primary)", fontSize: 14, opacity: syncing ? 0.7 : 1 }}
            >
